...
export type Resource = {
  _type: "resource";
  type?: "documentation" | "guide" | "repository" | "article" | "download" | "link";
  title?: string;
  description?: string;
  url?: string;
};
...
export type LearningOutcome = {
  ...
  icon?: "layers" | "database" | "gauge" | "cloud" | "code" | "shield" | "sparkles" | "workflow" | "puzzle" | "rocket" | "terminal" | "video";
  title?: string;
  description?: string;
};
...
export type COURSE_BY_SLUG_QUERY_RESULT = {
  ...
  learningOutcomes: Array<{
    _key: string;
    icon: "cloud" | "code" | "database" | "gauge" | "layers" | "puzzle" | "rocket" | "shield" | "sparkles" | "terminal" | "video" | "workflow" | null;
    title: string | null;
...
// Query: *[_type == "lesson" && slug.current == $slug][0] {    _id,    title,    "slug": slug.current,    videoUrl,    thumbnail,    duration,    freePreview,    studentCount,    notes,    keyPoints,    proTip,    resources[] {      _key,      type,      title,      description,      url    }  }
export type LESSON_BY_SLUG_QUERY_RESULT = {
  ...
  resources: Array<{
    _key: string;
    type: "article" | "documentation" | "download" | "guide" | "link" | "repository" | null;
    title: string | null;
    description: string | null;
    url: string | null;
  }> | null;
...
// Query: *[_type == "course" && references($lessonId)][0] {    title,    "slug": slug.current,    level,    modules[] {      title,      lessons[]-> {        _id,        "slug": slug.current      }    }  }
